...
var produit_1 = require("../service/produit");
var ProduitController = /** @class */ (function () {
    ...
    ProduitController.prototype.getProdById = function (body) {
    ...
    ProduitController.prototype.createProduct = function (produit) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    ProduitController.prototype.deleteProduit = function (produit) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
