...
var categorie_1 = require("../service/categorie");
var CatController = /** @class */ (function () {
    function CatController() {
        this.logger = new logger_1.APILogger();
        this.Categorie = new categorie_1.Categorie();
    }
    CatController.prototype.getCatById = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.logger.info('Controller: getComById', null);
                        return [4 /*yield*/, this.Categorie.getCatById(body)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CatController.prototype.createCategorie = function (cat) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.logger.info('Controller: createCommande', cat);
                        return [4 /*yield*/, this.Categorie.createCat(cat)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CatController.prototype.deleteCat = function (cat) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.logger.info('Controller: delete commande', cat);
                        return [4 /*yield*/, this.Categorie.deleteCat(cat)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
